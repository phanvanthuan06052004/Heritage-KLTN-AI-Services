...
EMBEDDING_CATALOG: dict[str, EmbeddingModelSpec] = {
    ...
    "ninerouter/gemini/gemini-embedding-2-preview": EmbeddingModelSpec(
        id="ninerouter/gemini/gemini-embedding-2-preview",
        provider="ninerouter",
        model_id="gemini/gemini-embedding-2-preview",
        dimension=3072,
        max_input_tokens=8192,
        label="9Router Gemini Embedding 2 Preview (3072d)",
        cost_per_1m_tokens=None,
        notes="Routed through 9Router. Dimension verified against local 9Router.",
    ),
}
