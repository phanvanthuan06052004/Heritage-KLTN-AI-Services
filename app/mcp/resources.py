"""
Heritage AI MCP Resources — static/semi-static data exposed to Claude.
...
def register_resources(mcp: FastMCP):
    ...
    @mcp.resource("heritage://about")
    async def about_heritage() -> str:
        """About this Heritage AI Services instance — capabilities and instructions."""
        return (
            "# Heritage AI Knowledge Base\n\n"
            "You are connected to the Heritage AI Knowledge Base. Knowledge is organized "
    ...
    @mcp.resource("heritage://wiki-index")
