...
A Skill is a packaged capability — a custom agent, a specialized prompt, or a tool bundle — that your organization develops and distributes through Heritage AI Services. Think of it as an internal app store for AI capabilities.
...
1. Heritage AI Services resolves their identity and permission scope
