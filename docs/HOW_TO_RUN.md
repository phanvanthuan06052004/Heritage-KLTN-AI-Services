# Heritage AI Services — How to Run (Development)
...
On first startup, Heritage AI Services will:
...
curl -X POST http://localhost:5055/api/auth/login \
  ...
  -d '{"email": "admin@heritage-ai.local", "password": "admin123"}'
```
